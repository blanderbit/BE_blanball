...
RESPONSE_TO_THE_REQUEST_FOR_PARTICIPATION = '{user_name},your application for participation in event №{event_id} was {response_type}'
...
ALREADY_IN_EVENT_FANS_LIST_ERROR = {'error': 'Already in the event fans list'}
