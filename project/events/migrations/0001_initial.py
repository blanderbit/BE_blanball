# Generated by Django 4.1.1 on 2022-10-25 09:14
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('Man', 'Man'), ('Wooman', 'Wooman')], max_length=10)),
        ...
        migrations.CreateModel(
            name='InviteToEvent',
            fields=[
                ('requesttoparticipation_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='events.requesttoparticipation')),
            ],
            options={
