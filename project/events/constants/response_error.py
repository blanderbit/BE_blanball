...
THIS_USER_CAN_NOT_BE_INVITED: dict[str, str] = {
    "error": "this_user_cannot_be_invited"
}
NO_PRICE_DESK_ERROR: dict[str, str] = {
   "error": "price_description_required"
}
SENT_INVATION_ERROR: dict[str, str] = {
    "error": "cant_invite_yourself"
}
