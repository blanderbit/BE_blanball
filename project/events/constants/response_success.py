...
APPLICATION_FOR_PARTICIPATION_SUCCESS: dict[str, str] = {"sent_request_to_participation"}
...
USER_REMOVED_FROM_EVENT_SUCCESS: dict[str, str] = {
    "success": "removed_user_from_event"
}
