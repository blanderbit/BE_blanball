...
UPDATE_MESSAGE_ACCEPT_OR_DECLINE_INVITE_TO_EVENT: str = 'update_message_accept_or_decline_invite_to_event' 
UPDATE_MESSAGE_ACCEPT_OR_DECLINE_REQUEST_TO_PARTICIPATION: str = 'update_message_accept_or_decline_request_to_participation' 
