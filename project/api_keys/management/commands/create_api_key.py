...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser) -> None:
        ...
        # Optional arguments
        parser.add_argument('-fn', '--file-name', type=str, help='Change the name of the output file. According to the "api_key.json" standard', )
        parser.add_argument('-no', '--no-output', action='store_true', help='With this argument, the api key will not be written to the file', )
        parser.add_argument('-np', '--no-print', action='store_true', help='With this argument, the created key will not be printed to the console', )
        parser.add_argument('-oc', '--only-create', action='store_true', help='With this argument, the key will simply be created in the database without writing to a file and output to the console', )
