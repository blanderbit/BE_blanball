# Generated by Django 4.0.4 on 2022-08-10 05:19
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('Man', 'Man'), ('Woomen', 'Woomen'), ('All', 'All')], max_length=10)),
                ...
                ('amount_members', models.PositiveSmallIntegerField(validators=[django.core.validators.MinValueValidator(6), django.core.validators.MaxValueValidator(50)])),
                ...
                ('current_users', models.ManyToManyField(blank=True, related_name='current_rooms', to='authentication.user')),
            ],
        ),
    ]
