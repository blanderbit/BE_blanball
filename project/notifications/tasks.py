...
def send_to_user(user:User,notification_text:str,message_type:str):
...
def send_notification_to_subscribe_event_user(event:Event,notification_text:str,message_type:str):
